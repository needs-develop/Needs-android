        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (list_itemArrayList.size() == 0) {
                    Log.d("시간테스트", "시간테스트");
                    findViewById(R.id.myreply_no_list).setVisibility(View.VISIBLE);
                } else {
                    Log.d("시간 풀 테스트", "시간 풀 테스트");
                    listViewReply.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        @Override
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            // if data equals "data"
                            if (list_itemArrayList.get(position).getData().equals("data")) {
                                Intent intent2 = new Intent(MyReplyActivity.this, HomeContent.class);
                            ...
                            // if data equals "freedata"
                                ...
                                Intent intent2 = new Intent(MyReplyActivity.this, HomeFreeContent.class);
