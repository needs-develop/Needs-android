...
public class BoardListSettingAdapter extends BaseAdapter {

    ArrayList<BoardListSetting> data = new ArrayList<BoardListSetting>();
    private ArrayList<BoardListSetting> list_itemArrayList = data;
    ...
    public BoardListSettingAdapter(Context context, ArrayList<BoardListSetting> data) {
        this.data = data;
